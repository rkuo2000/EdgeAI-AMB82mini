...
String prompt_msg = "Just say the word in the picture?";
...
void loop() {
  if ((digitalRead(buttonPin)) == 1) {
    ...
    // LLM Text
    prompt_msg = "please make a short sentence with "+text;
    Serial.println(prompt_msg);
    String msg = llm.geminitext(Gemini_key, "gemini-2.0-flash", prompt_msg, client);    
    tft.println(msg);

    // Text-To-Speech & play mp3 file
    tts.googletts(mp3Filename, msg, "en-US");
    delay(500);
    sdPlayMP3(mp3Filename);
