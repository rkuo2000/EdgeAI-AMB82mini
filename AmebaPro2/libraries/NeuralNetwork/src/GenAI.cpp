...
// 2025.11.07 added by rkuo2000
// Server: Google AI Studio
String GenAI::geminichat(String key, String model, String message, WiFiSSLClient client)
{
    const char *myDomain = "generativelanguage.googleapis.com";
    String getResponse = "", Feedback = "";
    Serial.println("Connect to " + String(myDomain));
...
// Server: Ollama
String GenAI::ollamavision(String domain_ip_addr, String model, String message, uint32_t img_addr, uint32_t img_len, WiFiClient client)
{
    const char *myDomain = domain_ip_addr;
    String getResponse = "", Feedback = "";
    Serial.println("Connect to " + String(myDomain));
...
// Server: Ollama
String GenAI::ollamachat(String domain_ip_addr, String model, String message, WiFiClient client)
{
    const char *myDomain = domain_ip_addr;
    String getResponse = "", Feedback = "";
    Serial.println("Connect to " + String(myDomain));
